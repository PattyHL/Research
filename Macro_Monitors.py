...
FRED_US_Economy_series = ['US_GDPR', 'US_CPI', 'USDEUR', 'US_10YT', 'TWUSD', 'TWUSD_N', 'US_EFFR', 'US_UI4WMA', 'US_IP', 'US_PAYRLS', 'SP500', 'US_FSI', 'US_10Y2YYC', 'US_3MT', 'US_UR', 'US_Wlsh5K', 'US_CapUt', 'US_5Y5Y', 'US_UMICHINF']
FRED_US_Economy_source_list = ['A191RL1Q225SBEA', 'CPIAUCSL', 'DEXUSEU', 'DGS10', 'DTWEXM', 'DTWEXBGS' ,'FEDFUNDS', 'IC4WSA', 'INDPRO', 'PAYEMS', 'SP500', 'STLFSI', 'T10Y2Y', 'TB3MS', 'UNRATE', 'WILL5000INDFC', 'TCU', 'T5YIFR', 'MICH']
...
sample_start=dt.datetime.strptime("1978-01", "%Y-%m")
sample_end=dt.datetime.strptime("2023-06", "%Y-%m")
...
X = FRED_US_Economy_data[['TWUSD_rb', 'US_UR', 'US_EFFR', 'US_UMICHINF', 'US_IP', 'US_PAYRLS']]
...
plt.plot(X_scaled)
plt.plot(FRED_US_Economy_data[['TWUSD_rb', 'US_UR', 'US_EFFR', 'US_UMICHINF', 'US_IP']])
